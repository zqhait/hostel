package com.uton.hostel.controller;

/**
 * @Auther: zxx
 * @Date: 2018/4/12
 * @Description:用户信息控制器  控制用户基本信息数据
 */
...
import com.uton.hostel.DjhStudentApp;
import com.uton.hostel.ui.login.bean.BeUser;
import com.uton.hostel.ui.login.bean.BeUserAuth;
import com.uton.hostel.util.SpUtil;
